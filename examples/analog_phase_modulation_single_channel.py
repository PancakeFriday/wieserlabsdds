...
Here, we generate a single tone using the DDS and modify its phase using
a signal from outside.

To test this example, connect channel 0 of slot 0 to an oscilloscope.
Into analog in channel 0 of slot 0, connect a signal generator with 10us pulse.
To see the phase jumps, it is best to have a square wave with 1V upper and -1V lower level
"""
